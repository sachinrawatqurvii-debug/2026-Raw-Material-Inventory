...
const Stock = () => {
  ...
  const displayItems = searchTerm
    ...
    : stock.slice(startIndex, endIndex);
        ...
        <div className="px-6 py-3 bg-blue-50 border-b border-blue-100 flex justify-between items-center">
          <div className="flex items-center gap-2 text-sm">
            <span className="px-3 py-1 rounded-full bg-blue-100 text-blue-800 font-medium">
              {searchTerm ? filteredData.length : stock.length} Total Items
            </span>
            {searchTerm && (
          ...
          <p className="text-gray-600">
            ...
            <span className="font-medium">
              {Math.min(endIndex, searchTerm ? filteredData.length : stock.length)}
            </span>{" "}
            of{" "}
            <span className="font-medium">
              {searchTerm ? filteredData.length : stock.length}
            </span>
          </p>
        </div>
                    ...
                    <td className="px-6 py-4">
                      ...
                      >
                        ...
                        <span>
                          ...
                          {`${curStock.availableStock?.toFixed(2)} MTR`}
